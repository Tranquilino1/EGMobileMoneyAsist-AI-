...
data class EditTransactionViewState(
    ...
    val voiceAgentUiState: VoiceAgentUiState
)
...
sealed interface EditTransactionViewEvent {
    ...
    data class OnAttachmentChanged(val path: String?) : EditTransactionViewEvent
    data object StartVoiceRecording : EditTransactionViewEvent
    data object StopVoiceRecording : EditTransactionViewEvent
