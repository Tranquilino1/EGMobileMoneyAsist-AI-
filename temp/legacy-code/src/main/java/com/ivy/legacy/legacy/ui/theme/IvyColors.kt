...
@Deprecated("Old design system. Use `:ivy-design` and Material3")
val Black = Color(0xFF0B0D11)

// Primary
@Deprecated("Old design system. Use `:ivy-design` and Material3")
val Ivy = Color(0xFF10B981)
...
@Deprecated("Old design system. Use `:ivy-design` and Material3")
val MediumBlack = Color(0xFF141821)
...
val GradientPurple = Gradient(Purple, Color(0xFF34D399))
...
@Deprecated("Old design system. Use `:ivy-design` and Material3")
val GradientIvy = Gradient(Ivy, Color(0xFF0D9488))
